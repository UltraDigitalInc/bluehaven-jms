...
var v31=0
popup.style.backgroundColor=v09[4]
var array=eval(v12)
var v13
for(v13=0;v13<array.length/3;v13++){
var v30=(array[v13*3+2])?(v12+"_"+parseInt(v13+1)):null
v31+=f03(q,popup,null,array[v13*3+1],array[v13*3],v30,v09,(v13==array.length/3-1),v31,popup)}
popup.style.height=v31+q.bord*2
popup.maxHeight=v31+q.bord*2
var v28=0
return popup}
function f06(q,popupId){
if(popupId.indexOf('_')==-1){var hideWnd=getElementById(q.v18,'HideItem');if(hideWnd)hideWnd.style.display='none';}
...
if(popup.id.indexOf('_')==-1){var hideWnd=getElementById(q.v18,'HideItem');if(hideWnd)hideWnd.style.display='';}
popup.style.left=x
popup.style.top=y
popup.style.display=""
var v15=f19(q,popup)
