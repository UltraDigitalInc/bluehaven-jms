...
function chistory_list()
{
	...
	$qryA = "SELECT officeid,finan_off,finan_from,fsenable,fscustomer,enquickbooks FROM offices WHERE officeid=".$_SESSION['officeid'].";";
	$resA = mssql_query($qryA);
	$rowA = mssql_fetch_array($resA);
	...
	else
	{
		...
		if ($_SESSION['llev']!=0 && $row['cid']!=0)
		{
			...
			echo "      						<td align=\"left\" class=\"gray\" width=\"100\">".$row['custid']."</td>\n";
	...
	$o_ar=array(55,56,75,144,89,97,200);
	if (
...
function onesheet_comments_display($cid,$tranid)
{
	...
	echo "									<table>\n";
	echo "				   						<tr>\n";
	echo "				      						<td valign=\"top\" class=\"gray\" align=\"left\">Type</td>\n";
	echo "				      						<td valign=\"top\" class=\"gray\" align=\"left\">\n";
	...
	{	
		echo "												<select name=\"commentflag\" id=\"cmntflag\">\n";
	...
	{
		echo "												<input class=\"transnb\" type=\"image\" src=\"images/save.gif\" alt=\"Save Comment\" onClick=\"return EmptyFieldAlert('mtext');\">\n";
	}
	...
	{
	if (isset($cmnt_ar) and is_array($cmnt_ar) and count($cmnt_ar) > 0)
	{
		echo "   <tr>\n";
		echo "      <td colspan=\"2\" align=\"left\">\n";
		echo "			<table class=\"outer\" width=\"100%\">\n";
		echo "   			<tr>\n";
		echo "      			<td class=\"ltgray_und\" colspan=\"2\" align=\"left\"><b>Comment / Service History</b></td>\n";
		echo "   			</tr>\n";
		echo "	   			<tr>\n";
		echo "      			<td align=\"center\" valign=\"top\" class=\"gray\">\n";
		echo "					<table align=\"center\" width=\"100%\">\n";
		echo "   					<tr>\n";
		echo "      					<td align=\"left\" width=\"100\"><b>Date</b></td>\n";
		echo "     	 					<td align=\"left\" width=\"100\"><b>Name</b></td>\n";
		echo "      					<td align=\"left\" width=\"50\"><b>Stage</b></td>\n";
		echo "      					<td align=\"left\" width=\"50\"><b>Ticket</b></td>\n";
		echo "      					<td align=\"left\">\n";
		echo "      						<table width=\"100%\">\n";
		echo "      							<tr>\n";
		...
		//HelpNode('CommentServiceHistoryPanel',5);
		...
		foreach ($cmnt_ar as $nc_ar => $vc_ar)
		{
			echo "   						<tr>\n";
			echo "   							<td align=\"left\" valign=\"top\" class=\"".$vc_ar['cmt_tbg']."\">".date('m/d/y g:iA',strtotime($vc_ar['mdate']))."</td>\n";
			echo "								<td align=\"left\" valign=\"top\" class=\"".$vc_ar['cmt_tbg']."\">".$vc_ar['lname']." ".$vc_ar['fname']."</td>\n";
			echo "								<td align=\"left\" valign=\"top\" class=\"".$vc_ar['cmt_tbg']."\">".$vc_ar['stage']."</td>\n";
			echo "								<td align=\"left\" valign=\"top\" class=\"".$vc_ar['cmt_tbg']."\">\n";
			
			if (isset($vc_ar['cstatus']) and strlen($vc_ar['cstatus']) > 0)
			{
				echo $vc_ar['cstatus'];
			}
			
			echo "								</td>\n";
			echo "								<td align=\"left\" valign=\"top\" class=\"".$vc_ar['cmt_tbg']."\">".htmlspecialchars_decode($vc_ar['mtext'])."</td>\n";
			echo "   						</tr>\n";
		}
...
function maplink($a1,$c1,$s1,$z1)
{
	...
	else
	{
		...
		$cyp	="US";
		$cid	="&cid=lfmaplink";
		$acl	=">Mapquest <img src=\"images/link.png\"></a>";
...
function form_element_ACC($id,$trig,$r_estdata,$type)
{
	...
	else
	{
		if ($rowA[5]==0)
		{
			...
			echo "                           <input type=\"hidden\" name=\"$s4\" value=\"$bp\">\n";
			echo "                        </td>\n";
			echo "                             <td class=\"$tbg\" width=\"25px\" valign=\"bottom\" align=\"right\">\n";
			echo                            $rowB[1];
			echo "                        </td>\n";
		...
		)
		{
			...
			echo "                           <input type=\"hidden\" name=\"$s10\" value=\"$rowA[14]\">\n";
			echo "                        </td>\n";
			echo "                        <td class=\"$tbg\" width=\"75px\" valign=\"bottom\" align=\"center\">$bullet</td>\n";
			echo "                        <td class=\"$tbg\" width=\"60px\" valign=\"bottom\" align=\"right\">$bp</td>\n";
			echo "                        <td class=\"$tbg\" width=\"25px\" valign=\"bottom\" align=\"center\">$rowB[1]</td>\n";
			echo "                        <td class=\"$tbg\" width=\"50px\" valign=\"bottom\" align=\"center\">\n";
...
function form_element_ACC_NEW($id,$trig,$r_estdata,$type,$aid,$tbg)
{
	...
	else
	{
		...
		)
		{
			...
			//echo "					<table>\n";
			echo "                     <tr>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz1."\" valign=\"bottom\" align=\"left\">";
			...
			echo "                           <input type=\"hidden\" name=\"$s10\" value=\"$aid[14]\">\n";
			echo "                        </td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz2."\" valign=\"bottom\" align=\"center\">".$bullet."</td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz3."\" valign=\"bottom\" align=\"right\">$bp</td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz4."\" valign=\"bottom\" align=\"center\">$rowB[1]</td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz5."\" valign=\"bottom\" align=\"center\">\n";
		...
		elseif  ($aid[5]==33)
		{
			...
			if ($_SESSION['call']=='view_addnew' && $db_id==$id)
			{
				echo "                             <td class=\"$tbg\" width=\"".$sz3."\" valign=\"bottom\" align=\"right\"><input class=\"bboxbr\" type=\"text\" name=\"$s4\" size=\"6\" maxlength=\"20\" value=\"$db_rp\"></td>\n";
				echo "                             <td class=\"$tbg\" width=\"".$sz4."\" valign=\"bottom\" align=\"right\">$rowB[1]</td>\n";
				echo "                             <td class=\"$tbg\" width=\"".$sz5."x\" valign=\"bottom\" align=\"center\">\n";
				echo "                           <input class=\"transnb\" type=\"checkbox\" name=\"$s2\" value=\"1\" CHECKED>\n";
			}
			elseif ($_SESSION['call']=='create_add' && $db_id==$id)
			{
			...
			{
				echo "                             <td class=\"$tbg\" width=\"60px\" valign=\"bottom\" align=\"right\"><input class=\"bboxbr\" type=\"text\" name=\"$s4\" size=\"6\" maxlength=\"20\" value=\"$aid[7]\"></td>\n";
				echo "                             <td class=\"$tbg\" width=\"25px\" valign=\"bottom\" align=\"right\">$rowB[1]</td>\n";
				echo "                             <td class=\"$tbg\" width=\"50px\" valign=\"bottom\" align=\"center\">\n";
				echo "                           <input class=\"transnb\" type=\"checkbox\" name=\"$s2\" value=\"1\">\n";
			}
		...
		elseif  ($aid[5]==54)
		{
			...
			echo "                        </td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz2."\" valign=\"bottom\" align=\"center\">$bullet</td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz3."\" valign=\"bottom\" align=\"right\"></td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz4."\" valign=\"bottom\" align=\"right\">$rowB[1]</td>\n";
			echo "                        <td class=\"$tbg\" width=\"".$sz5."\" valign=\"bottom\" align=\"right\">\n";
...
function dates_display_job($cid)
{
	...
	$qryA = "SELECT added,submitted,updated,digdate,closed,ListID,EditSequence,securityid,acc_status FROM jobs WHERE officeid='".$_SESSION['officeid']."' AND jobid='".$row['jobid']."';";
	$resA = mssql_query($qryA);
	$rowA = mssql_fetch_array($resA);
	...
	*/
	...
	/*
	if (isset($rowAb['enmas']) and $rowAb['enmas']==1)
	{
		echo "								<tr>\n";
		echo "                  				<td class=\"gray\" align=\"right\" width=\"".$wd1."\"><b>MAS Status: </b></td>\n";
		echo "                        			<td class=\"gray\" align=\"left\">\n";
	...
	if (isset($rowAb['enquickbooks']) and $rowAb['enquickbooks']==1)
	{
		$err=0;
		echo "								<tr>\n";
		echo "                  				<td class=\"gray\" valign=\"top\" align=\"right\" width=\"".$wd1."\"><b>QB Status: </b></td>\n";
		echo "                        			<td valign=\"top\" align=\"left\"><div id=\"statusbox_AccountingStatus\">\n";
		
		if ($rowA['acc_status']==0)
		{
			echo 'Unreleased<br>';
		}
		...
		{
			echo "								<tr>\n";
			echo "                  				<td class=\"gray\" valign=\"top\" align=\"right\" width=\"".$wd1."\"><b>QB Job ID: </b></td>\n";
			echo "                        			<td valign=\"top\" align=\"left\">".$rowA['ListID']."</td>\n";
			echo "                     			</tr>\n";
		}
	}
	*/
