...
<div id="menu">
	<ul id="toplevel">
		<li><a class="fly" href="#url">Menu<!--[if gte IE 7]><!--></a><!--<![endif]-->
...
<div id="menu">
	<ul id="toplevel">
		...
		<li><a href="#url">Home6</a></li>
		<li><a href="#url">Home7</a></li>
		<li><a href="#url">Home8</a></li>
	</ul>
</div>
...
<div id="menu">
	<ul id="toplevel">
		<li><a href="#url">Home9</a></li>
		<li><a href="#url">Home0</a></li>
		<li><a href="#url">HomeA</a></li>
		<li><a href="#url">HomeB</a></li>
	</ul>
</div>
...
<div id="menu">
	<ul id="toplevel">
		...
		<li><a class="fly" href="#url">Resort<!--[if gte IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
			<ul>
