...
function main_button_menu() {
	//include ('help_nodes.php');
	$dis	="";
	$_SESSION['admin_offs'] =array(89,138);
	$off_ar=array(55,60,89,75,99,144);
	$qry1= "SELECT officeid,enest,encon,enjob,enmas,enquickbooks,finan_off,fsenable,fscustomer,fsshared,fsoffice,purchaseorder,accountingsystem,otype FROM offices WHERE officeid=".$_SESSION['officeid'].";";
...
function leads_maint_button_menu()
{
	...
	if ($_SESSION['tlev'] >= 7 && $_SESSION['llev'] >= 7)
	{
		...
		echo "						<button class=\"btnsysmenu\">Unsorted</button>\n";
		echo "         			</form>\n";
		echo "					</td>\n";
		echo "      			<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		...
		echo "						<button class=\"btnsysmenu\">Access</button>\n";
		echo "         			</form>\n";
		echo "					</td>\n";
	}
	...
	if (($_SESSION['tlev'] >= 9 && $_SESSION['m_llev'] >= 9) or $row2['officeid']==89)
	{
		...
		*/
		...
		echo "						<button class=\"btnsysmenu\">Move Leads</button>\n";
		echo "         			</form>\n";
		echo "					</td>\n";
		echo "      			<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		...
		echo "						<button class=\"btnsysmenu\">Lead Import</button>\n";
		echo "         			</form>\n";
		echo "					</td>\n";		
	}
	...
	echo "         			<form method=\"post\">\n";
	echo "						<input type=\"hidden\" name=\"action\" value=\"maint\">\n";
	echo "						<button class=\"btnsysmenu\">Maint Menu</button>\n";
	echo "         			</form>\n";
	echo "					</td>\n";
	echo "      			<td align=\"right\">\n";
...
function maint_button_menu($valdis)
{
	...
	if ($_SESSION['emailtemplates'] >= 6 and ($_SESSION['securityid']==26 or $_SESSION['securityid']==332 or $_SESSION['tester']==1)) {
		echo "      		<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"maint\">\n";
...
function pbconfig_button_menu($valdis)
{
	...
	if (isset($_SESSION['m_plev']) && $_SESSION['m_plev'] >= 8)
	{
		...
		echo "						<input type=\"hidden\" name=\"action\" value=\"pbconfig\">\n";
		echo "						<input type=\"hidden\" name=\"call\" value=\"bpool\">\n";
		echo "						<button class=\"btnsysmenu\">Base Pool</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
		echo "      		<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		...
		echo "						<input type=\"hidden\" name=\"call\" value=\"cat\">\n";
		echo "						<input type=\"hidden\" name=\"subq\" value=\"list\">\n";
		echo "						<button class=\"btnsysmenu\">Category</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
	}
	...
	if ((isset($_SESSION['m_plev']) and $_SESSION['m_plev'] >= 2) and $row1['encon'] == 1)
	{
		...
		echo "						<input type=\"hidden\" name=\"catid\" value=\"0\">\n";
		echo "						<input type=\"hidden\" name=\"order\" value=\"seqn\">\n";
		echo "						<button class=\"btnsysmenu\">Retail</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
	}
	...
	if (isset($_SESSION['m_plev']) and $_SESSION['m_plev'] >= 9)
	{
		...
		echo "                  	<input type=\"hidden\" name=\"subq\" value=\"acc\">\n";
		echo "                  	<input type=\"hidden\" name=\"phsid\" value=\"1\">\n";
		echo "						<button class=\"btnsysmenu\">Labor Cost</button>\n";
		echo "					</form>\n";
		echo "				</td>\n";
		echo "				<td>\n";
		echo "					<form method=\"post\">\n";
		...
		echo "						<input type=\"hidden\" name=\"subq\" value=\"inv\">\n";
		echo "						<input type=\"hidden\" name=\"phsid\" value=\"10\">\n";
		echo "						<button class=\"btnsysmenu\">Inv Cost</button>\n";
		echo "					</form>\n";
		echo "				</td>\n";
	}
	...
	if (isset($_SESSION['m_plev']) and $_SESSION['m_plev'] >= 8)
	{
		if ($_SESSION['securityid']==26||$_SESSION['securityid']==332||$_SESSION['securityid']==1991)
		{
			...
			echo "						<input type=\"hidden\" name=\"subq\" value=\"copy_list\">\n";
			echo "						<input type=\"hidden\" name=\"order\" value=\"seqn\">\n";
			echo "						<button class=\"btnsysmenu\">Copy</button>\n";
			echo "         			</form>\n";
			echo "				</td>\n";
		}
	}
	...
	if (isset($_SESSION['m_plev']) && $_SESSION['m_plev'] >= 8)
	{
		...
		echo "						<input type=\"hidden\" name=\"call\" value=\"mat\">\n";
		echo "						<input type=\"hidden\" name=\"subq\" value=\"base_vendor_list\">\n";
		echo "						<button class=\"btnsysmenu\">Mat Master</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
		echo "      		<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		...
		echo "						<button class=\"btnsysmenu\">Active Mats</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
	}
	...
	if ($_SESSION['rlev'] >= 6 && $row1['encon'] == 1 && $row1['finan_off']==0)
	{
		...
		echo "						<button class=\"btnsysmenu\">Gen PB</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
		echo "      		<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		...
		echo "						<button class=\"btnsysmenu\">Gen Cost</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
	}
	...
	if ((isset($_SESSION['m_plev']) and $_SESSION['m_plev'] >= 1) and $row1['encon'] == 1)
	{
		...
		echo "						<input type=\"hidden\" name=\"subq\" value=\"list\">\n";
		echo "						<button class=\"btnsysmenu\">PB Analyze</button>\n";
		echo "         			</form>\n";
		echo "				</td>\n";
	}
