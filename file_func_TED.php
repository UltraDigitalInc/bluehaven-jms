...
function list_file_ENT()
{
	...
	{		
		...
		{		
			...
			echo "			<div id=\"filelisting_OFF_2\">\n";
			echo "				<ul>\n";
			echo "					<li><a href=\"#FTree\">Shared Files</a> <img class=\"JMStooltip\" src=\"images/help.png\" title=\"Browse the Tree below to access Documents provided by BHNM. Click on the Icon to Download.\"></li>\n";
