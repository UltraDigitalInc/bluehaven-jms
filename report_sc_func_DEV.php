...
function SalesYearStart($yr) {
	$out='';
	$out=$out."					<tr>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"center\" width=\"20\"><img src=\"images/pixel.gif\"></td>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"left\" colspan=\"14\"><b>Sales Year ".$yr." Begin</b></td>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"center\" width=\"10\"><img id=\"trgSY_".$yr."\" class=\"trigSalesYear pointer\" src=\"images/bullet_toggle_plus.png\" title=\"Click to Expand this Sales Year\"></td>\n";
	$out=$out."					</tr>\n";
	
	return $out;
}

function SalesYearEnd($yr,$bal=null,$style,$class) {
	$ebal=($bal < 0)?'<font style="color:red;">'.number_format($bal, 2, '.', '').'</font>':number_format($bal, 2, '.', '');
	
	$out='';
	//$out=$out."					<tr class=\"togSY_".$yr." ".$class."\">\n";
	$out=$out."					<tr >\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"center\" width=\"20\"><img src=\"images/pixel.gif\"></td>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"left\" colspan=\"13\"><b>Sales Year ".$yr." Final Balance</b></td>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"right\" width=\"60\">".$ebal."</td>\n";
	$out=$out."                      <td class=\"ltgray_sidesb\" align=\"center\" width=\"10\"><img src=\"images/pixel.gif\"></td>\n";
	$out=$out."					</tr>\n";
	
	return $out;
}

function procCommissions($main_ar) {	
	if (is_array($main_ar)) {
		//$bcrate_ar=array();
		//$bccomm_ar=array();
		$oucomm_ar=array();
...
function srpage() {
	...
	$qry0c = "SELECT brept_yr FROM [jest].[dbo].[bonus_schedule_config] WHERE active=1;";
    $res0c = mssql_query($qry0c);
    $row0c = mssql_fetch_array($res0c);
    
	$active_sales_year=(isset($row0c['brept_yr']) and $row0c['brept_yr']!=0)?$row0c['brept_yr']:0;
	$totalcom_ar=array('C'=>0,'M'=>0,'B'=>0,'P'=>0,'L'=>0,'D'=>0,'A'=>0);
	
	//echo 'ASY: '.$active_sales_year.'<br>';
	
	//if ()
	
	echo "<script type=\"text/javascript\" src=\"js/jquery_srpage_DEV.js?".time()."\"></script>\n";
    ...
    if ($nrow0 > 0)
    {
        ...
        echo "                                  </td>\n";
		echo "									<td align=\"right\">\n";
		echo "										<div onclick=\"SwitchMenu('optionselect')\"><img class=\"pointer\" src=\"images/bullet_toggle_plus.png\" title=\"Report Options\"></div>";
		echo "									</td>\n";
        echo "                                  <td><input class=\"transnb_button pointer\" type=\"image\" src=\"images/arrow_refresh_small.png\" title=\"Refresh\"></td>\n";
		echo "					            </tr>\n";
		echo "					            <tr>\n";
		...
		echo "											<tr>\n";
        echo "												<td align=\"right\"><b>Remove Adjusts</b></td>\n";
        
        if (isset($_REQUEST['showadjust']) && $_REQUEST['showadjust']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showadjust\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showadjust\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
        echo "												<td align=\"right\"><b>Remove Bonus</b></td>\n";
        
        if (isset($_REQUEST['showbonus']) && $_REQUEST['showbonus']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showbonus\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showbonus\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
		echo "												<td align=\"right\"><b>Remove Commission</b></td>\n";
        
        if (isset($_REQUEST['showcommission']) && $_REQUEST['showcommission']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showcommission\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showcommission\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
		echo "												<td align=\"right\"><b>Remove Draws</b></td>\n";
        
        if (isset($_REQUEST['showdraw']) && $_REQUEST['showdraw']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showdraw\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showdraw\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
		echo "												<td align=\"right\"><b>Remove Loans</b></td>\n";
        
        if (isset($_REQUEST['showloan']) && $_REQUEST['showloan']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showloan\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showloan\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
        echo "												<td align=\"right\"><b>Remove Pending</b></td>\n";
        
        if (isset($_REQUEST['showpipeline']) && $_REQUEST['showpipeline']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showpipeline\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showpipeline\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
        echo "											<tr>\n";
        echo "												<td align=\"right\"><b>Remove Processor</b></td>\n";
        
        if (isset($_REQUEST['showprocessing']) && $_REQUEST['showprocessing']==0)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showprocessing\" value=\"0\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"showprocessing\" value=\"0\"></td>\n";
        }
		
		echo "											</tr>\n";
		echo "											<tr>\n";
        echo "												<td align=\"right\"><b>Calculate Pending</b></td>\n";
        
        if (isset($_REQUEST['calcpipeline']) && $_REQUEST['calcpipeline']==1)
        {        
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"calcpipeline\" value=\"1\" CHECKED></td>\n";
        }
        else
        {
            echo "												<td align=\"left\"><input class=\"transnb\" type=\"checkbox\" name=\"calcpipeline\" value=\"1\"></td>\n";
        }
    ...
    {
        echo '									<td align=\"right\" valign=\"top\"><b>No Sales Reps in this Company</b></td>';
		echo "					            </tr>\n";
    }
    ...
    if (isset($_REQUEST['stg']) && $_REQUEST['stg']==2 && isset($_REQUEST['sid']) && $_REQUEST['sid']!=0) {
        ...
        $qryB .= "exec jest..tlh_SRBeginBalance @sid=".(int) $_REQUEST['sid'].";";
		...
		$qry1 .= "exec jest..tlh_SalesRepPage ".(int) $_REQUEST['sid'].";";
        $res1  = mssql_query($qry1);
        $nrow1 = mssql_num_rows($res1);
        $highestprocdate=0;
		
		$brept_yr=array();
		$qry2 = "SELECT smo,syr,emo,eyr,brept_yr FROM bonus_schedule_config ORDER BY brept_yr ASC;";
        $res2 = mssql_query($qry2);        
		$nrow2= mssql_num_rows($res2);
		
		while ($row2 = mssql_fetch_array($res2)) {
			$brept_yr[$row2['brept_yr']]=array('start'=>date('m/d/Y',mktime(0, 0, 0, $row2['smo'], 1, $row2['syr'])),'end'=>date('m/t/Y',mktime(0, 0, 0, $row2['emo'], 1, $row2['eyr'])));
		}
		...
		echo "						</td>\n";
        echo "						<td align=\"right\"><b>Print Date</b> \n";
			...
			while ($row1 = mssql_fetch_array($res1))
			{
				if ($row1['Type']=='C' || $row1['Type']=='P' || $row1['Type']=='S' || $row1['Type']=='T')
				{
					if ($row1['Type']=='C')
					{
                        //echo 'C: '.$row1['Type'].'<br>';
						$qryC = "
							SELECT J1.contractamt,J1.contractdate,(select isnull(overunder,0) from jobs where officeid=J1.officeid and jobid=J1.jobid) as overunder,(select isnull(adjbook,0) from jobs where officeid=J1.officeid and jobid=J1.jobid) as adjbook
							FROM jdetail as J1
							WHERE J1.officeid=".$_SESSION['officeid']." AND J1.njobid='".$row1['JobNumber']."' AND J1.jadd=0;
							";
					...
					else
					{
						...
						$qryC = "
							SELECT J1.contractamt,J1.contractdate,(select isnull(overunder,0) from jobs where officeid=J1.officeid and jobid=J1.jobid) as overunder,(select isnull(adjbook,0) from jobs where officeid=J1.officeid and jobid=J1.jobid) as adjbook
							FROM jdetail as J1
							WHERE J1.officeid=".$_SESSION['officeid']." AND J1.jobid='".$row1['JobNumber']."' AND J1.jadd=0;
							";
					...
					if ($nrowC > 0)
					{
						...
						$ycd	=date('Y',strtotime($rowC['contractdate']));
				...
				$tycd=($ycd!=0)?$ycd:date('Y',strtotime($row1['Date']));
				
				$pmain_ar[$tycd][]=array(
					'sysyr'=>			date('Y',strtotime($row1['Date'])),
					'conyr'=>			$tycd,
		...
		//if (count($pmain_ar) > 0) {
		foreach ($pmain_ar as $pmn=>$pmv) {
			$tstyle='';
			$tclass='';
			echo SalesYearStart($pmn);
			
			$cnt=0;
			$main_ar=procCommissions($pmv);			
			foreach ($main_ar as $mn => $mv) {
				//$conyr=$mv['conyr'];
				$tstyle=($mv['conyr']!=$active_sales_year)?'style="display:none;"':'';
				$tclass=($mv['conyr']!=$active_sales_year)?'pastSalesYear':'currentSalesYear';
                ...
                if ($mv['Type']=='C' && (isset($_REQUEST['showcommission']) && $_REQUEST['showcommission']==1))
                {
					...
					$cnt++;
                    echo "					<tr class=\"togSY_".$mv['conyr']." ".$tclass."\" ".$tstyle.">\n";
                ...
                elseif ($mv['Type']=='R' && isset($_REQUEST['showbonus']) && $_REQUEST['showbonus']==1)
                {
					...
					$cnt++;
					echo "					<tr class=\"togSY_".$mv['conyr']." ".$tclass."\" ".$tstyle." title=\"Balance Validated\">\n";
                    echo "                      <td class=\"".$tbc."\" align=\"right\">".$cnt.".</td>\n";
                    echo "                      <td class=\"".$tbc."\" align=\"center\">".$mv['CD']."</td>\n";
                    echo "                      <td class=\"".$tbc."\" align=\"center\"><img src=\"images/pixel.gif\"></td>\n";
                    echo "                      <td class=\"".$tbc."\" align=\"left\">\n";
            ...
            */
			...
			echo SalesYearEnd($pmn,$tbal,$tstyle,$tclass);
        }
        /*
		else
        {
