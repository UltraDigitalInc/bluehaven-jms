...
function CreateContract()
{
	...
	{
		PaymentScheduleRW_TED($rowpre1['contractamt'],$rowpre2[0],$rowpre2[1]);
	}
	else
	{
	...
	//<script> 
	//(function() {
	//	var tabView = new YAHOO.widget.TabView('createcontract');
	//})();
	//</script>
	//
	//";
	...
	//echo "         						var cal1 = new calendar2(document.forms['createcontract'].elements['cdate']);\n";
...
function CreateContract_NEW()
{
	...
	$qrypre5	= "SELECT securityid,JobCommEdit FROM security WHERE officeid='".$_SESSION['officeid']."' AND securityid=".$_SESSION['securityid'].";";
	$respre5	= mssql_query($qrypre5);
	$rowpre5	= mssql_fetch_array($respre5);
	...
	echo "		<script type=\"text/javascript\" src=\"js/jquery_contract_create.js\"></script>\n";
	echo "			<table class=\"transnb\" align=\"center\" border=0>\n";
	echo "   			<tr>\n";
	echo "      			<td align=\"left\">\n";
	echo "						<table class=\"outer\" align=\"center\" width=\"400px\" border=0>\n";
	echo "   						<tr>\n";
	echo "      						<td class=\"gray\">\n";
	...
	//echo "<div id=\"createcontract_new\">\n";
    echo "	<h3><a href=\"#\">Contract Detail</a></h3>\n";
    echo "	<div>\n";
	echo "		<p>\n";
	...
	*/
	...
	{
		echo "   <tr>\n";
		echo "      <td align=\"right\" width=\"125\"><b>Financing</b></td>\n";
		echo "		<td align=\"left\" colspan=\"2\">\n";
		echo "			<select id=\"finan\" name=\"finan\">\n";
		echo "				<option value=\"0\">Select...</option>\n";
	...
	echo "	<h3><a href=\"#\">Commission Schedule</a></h3>\n";
	echo "	<div>\n";
	echo "		<p>\n";
	
	if ($rowpre5['JobCommEdit'] == 1)
	{
		CommissionScheduleRW_NEW_COMM_EDIT($comm_ar);
	}
	else
	{
		CommissionScheduleRW_NEW($comm_ar);
	...
	echo "	<h3><a href=\"#\">Payment Schedule</a></h3>\n";
	echo "	<div>\n";
	echo "		<p>\n";
	
	PaymentScheduleRW_NEW($rowpre1['contractamt'],$rowpre2[0],$rowpre2[1]);
	
	echo "		</p>\n";
	echo "	</div>\n";
	
	echo "	<h3><a href=\"#\">Accept</a></h3>\n";
	echo "	<div>\n";
	echo "		<p>\n";
	...
	echo "				<tr>\n";
	echo "					<td align=\"right\"><b>Accept & Save Contract</b></td>\n";
	echo "					<td align=\"right\" width=\"20\">\n";

	if ($errinp > 0)
	{
		echo "                  <input class=\"transnb\" type=\"image\" src=\"images/save.gif\" value=\"Apply\" title=\"Save Contract\" DISABLED>\n";
	}
	else
	{
		echo "                  <input class=\"transnb\" type=\"image\" src=\"images/save.gif\" value=\"Apply\" title=\"Save Contract\" onClick=\"return CreateContractAlerts()\">\n";
	}
...
function delete_est($estid)
{
	if ($_REQUEST['call']=="delete_est1")
	{
		$qryA = "SELECT * FROM est WHERE officeid='".$_SESSION['officeid']."' AND estid='".$estid."';";
		//$qryA = "SELECT * FROM cinfo WHERE officeid='".$_SESSION['officeid']."' AND estid='".$_SESSION['estid']."';";
		$resA = mssql_query($qryA);
	...
	{
		$qry = "SELECT * FROM est WHERE officeid='".$_SESSION['officeid']."' AND estid='".$estid."';";
		$res	= mssql_query($qry);
		$row	= mssql_fetch_array($res);
		$nrow	= mssql_num_rows($res);

		$qryA = "SELECT * FROM cinfo WHERE officeid='".$_SESSION['officeid']."' AND cid='".$row['ccid']."';";
		$resA = mssql_query($qryA);
		$rowA = mssql_fetch_array($resA);
...
function viewest_retail()
{
	...
	$qry0 = "SELECT officeid,newcommdate FROM offices WHERE officeid='".$_SESSION['officeid']."';";
	$res0 = mssql_query($qry0);
	$row0 = mssql_fetch_array($res0);
	
	$qry1 = "SELECT added,ccid,securityid FROM est WHERE officeid='".$_SESSION['officeid']."' AND estid='".$estid."';";
	$res1 = mssql_query($qry1);
	$row1 = mssql_fetch_array($res1);
	
	$qry2 = "SELECT securityid,sidm,newcommdate FROM security WHERE securityid='".$row1['securityid']."';";
	$res2 = mssql_query($qry2);
...
function viewest_retail_NEW_TEST_OLD()
{
	//error_reporting(E_ALL);
	//ini_set('display_errors','On');
	global $bctotal,$rctotal,$cctotal,$bmtotal,$rmtotal,$cmtotal,$showdetail,$callow,$ref1,$ref2,$discount,$invarray,$estidret,$taxrate,$tbid,$tbullets;
	...
	$qryC = "SELECT officeid,name,stax,sm,gm,bullet_rate,bullet_cnt,over_split,pft_sqft,encost,enest,com_rate,newcommdate FROM offices WHERE officeid='".$_SESSION['officeid']."';";
	$resC = mssql_query($qryC);
	$rowC = mssql_fetch_row($resC);
	...
	$qryQ  = "select cmid,rwdrate,ctgry from jest..CommissionBuilder where oid=".$_SESSION['officeid']." and active=1 and ctgry=1;";
	$resQ = mssql_query($qryQ);
	$rowQ = mssql_fetch_array($resQ);
    $nrowQ= mssql_num_rows($resQ);
	
	$qryQa  = "select cmid,rwdrate,ctgry from jest..CommissionBuilder where oid=".$_SESSION['officeid']." and active=1 and secid=".$viewarray['estsecid']." and ctgry=1;";
	...
	if (isset($dbg) && $dbg==1 && $_SESSION['securityid']==$tsecid)
	{
		...
		print_r($viewarray);
		echo $rowpreA[23].'<br>';
		//echo $rowpreAa['jobid'].'<br>';
		//echo $viewarray['jobid'].'<br>';
		echo "</pre>";
	}
	...
	//echo "<pre>";
	//print_r($viewarray);
	//print_r($commarray['commsched']);
	//echo "</pre>";

	echo "<table class=\"transnb\" width=\"900\" border=0>\n";
	echo "   <tr>\n";
	echo "      <td valign=\"top\" align=\"left\">\n";
	echo "         <table class=\"transnb\" align=\"center\" width=\"100%\" border=0>\n";
	echo "            <tr>\n";
	...
	{
		echo "						<td class=\"gray\" colspan=\"3\" align=\"left\"><b>Retail Addendum Estimate ".$estidret." on Job: <font color=\"red\">".$viewarray['jobid']."</font> for ".$rowC[1]."</b></td>\n";
	}
	else
	{
		echo "						<td class=\"gray\" colspan=\"3\" align=\"left\"><b>Retail Estimate</b></td>\n";
	}
	...
	echo "                     </tr>\n";
	echo "							<input type=\"hidden\" name=\"contdate\">\n";
	/*echo "                     <tr>\n";
	echo "							<td align=\"right\"><b>Contract</b></td>\n";
	echo "							<td align=\"left\">\n";
	
	if ($viewarray['added'] >= strtotime($rowC[12]))
	{
		if (isset($viewarray['contdate']) && $viewarray['contdate'] > strtotime('1/1/2002'))
		{
			echo "							<input type=\"text\" name=\"contdate\" id=\"contdate\" size=\"10\" maxlength=\"15\" value=\"".date('m/d/Y',$viewarray['contdate'])."\">\n";
		}
		else
		{
			echo "							<input type=\"text\" name=\"contdate\" id=\"contdate\" size=\"10\" maxlength=\"15\">\n";
		}
	}
	else
	{
	...
	echo "   <tr>\n";
	echo "      <td valign=\"top\" align=\"center\">\n";
	echo "         <table background=\"white\" cellpadding=0 cellspacing=0 bordercolor=\"gray\" width=\"100%\" border=1>\n";
	echo "           <form method=\"post\">\n";
	echo "           <input type=\"hidden\" name=\"officeid\" value=\"".$_SESSION['officeid']."\">\n";
	echo "           <input type=\"hidden\" name=\"action\" value=\"est\">\n";
	echo "           <input type=\"hidden\" name=\"call\" value=\"remove_acc\">\n";
	...
	echo "			 <input type=\"hidden\" name=\"esttype\" value=\"E\">\n";
	echo "           <tr>\n";
	echo "              <td class=\"wh\" align=\"left\" width=\"125\"><b>Category</b></td>\n";
	echo "              <td class=\"wh\" align=\"left\"><b>Item</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"30\"><b>Quan</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"30\"><b>Units</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"60\"><b>Retail</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"60\"><b>Comm</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"60\">\n";
	...
	if ($viewarray['status'] >= 2)
	{
		echo "<input class=\"transnb\" type=\"image\" src=\"images/cross.png\" value=\"Delete\" title=\"Delete Checked Items\" DISABLED>";
		//echo "						<input class=\"buttondkgry\" type=\"submit\" value=\"Delete\" DISABLED>\n";
	}
	else
	{
	...
	echo "           </tr>\n";
	echo "           <tr>\n";
	echo "              <td class=\"wh\" align=\"left\" width=\"125\">Base</td>\n";
	echo "              <td class=\"wh\" align=\"left\">Basic Pool</td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"30\">".$bpset[5]."</td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"30\">".$bpset[6]."</td>\n";
	echo "              <td class=\"wh\" align=\"right\" width=\"60\">".$fpbaseprice."</td>\n";
	echo "              <td class=\"wh\" align=\"right\" width=\"60\">".$fbcomm."</td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"60\"></td>\n";
	echo "           </tr>\n";
	...
	//$tbullets=4; //Simulated - Remove when test complete
	...
	echo "              <td class=\"wh\" align=\"right\"></td>\n";
	echo "              <td class=\"wh\" align=\"right\" width=\"30\"></td>\n";
	echo "              <td class=\"wh\" align=\"right\" width=\"60\">".$ftrcost."</td>\n";
	echo "              <td class=\"wh\" align=\"right\" width=\"60\">".$ftrcomm."</td>\n";
	echo "              <td class=\"wh\" align=\"center\" width=\"60\"></td>\n";
	echo "           </tr>\n";
	...
	if ($viewarray['status'] <= 1)
	{
		echo "                 <input class=\"transnbtextright\" type=\"text\" id=\"c_amt\" name=\"c_amt\" size=\"6\" maxlength=\"10\" value=\"".$fctramt."\">\n";
	}
	else
	{
		echo $fctramt;
	...
	/*if ($viewarray['status'] >= 2)
	{
		echo "                  <input class=\"transnb\" type=\"image\" src=\"images/save.gif\" value=\"Apply\" title=\"Save Retail Amount\" DISABLED>\n";
	}
	else
	{
		echo "                  <input class=\"transnb\" type=\"image\" src=\"images/save.gif\" value=\"Apply\" title=\"Save Retail Amount\">\n";
	}*/
	...
	echo "</form>\n";
	echo "           <tr>\n";
	echo "              <td class=\"wh\" colspan=\"2\" align=\"right\"><b>Over/<font color=\"red\">Under</font> Book</b></td>\n";
	echo "              <td class=\"wh\" align=\"center\"></td>\n";
	echo "              <td class=\"wh\" align=\"right\"></td>\n";
	echo "              <td class=\"wh\" align=\"right\">\n";
	...
	{
		echo "			<tr>\n";
		echo "				<td colspan=\"2\" align=\"right\"><b>Tax (".$taxrate[1]."):</b></td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\">".$frtax."</td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "			</tr>\n";
		echo "			<tr>\n";
		...
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\">".$fgrtcost."</td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "				<td align=\"right\"></td>\n";
		echo "			</tr>\n";
	...
	if ($nrowQ > 0)
	{
		if ($_SESSION['securityid']==268888888888888888888)
		{
			echo $viewarray['jobid'].'<br>';
		}
		...
		{
			$tadjcomm=CommissionScheduleRO_After_Contract($commarray);
		}
		else
		{
			//CommissionScheduleRO($commarray);
			
			$tadjcomm=CommissionScheduleRO($commarray);
		}
	}
	else
	{
		echo "			<tr>\n";
		echo "				<td colspan=\"7\" align=\"center\"><b>Commission Schedules have not been created for this Office. Contact Serena @ BHNM.</b></td>\n";
		echo "			</tr>\n";
	}
	...
	echo "      </td>\n";
	echo "      <td valign=\"top\" align=\"left\">\n";
	echo "         <table class=\"transnb\" cellpadding=0 cellspacing=0 bordercolor=\"gray\" border=0>\n";
	echo "            <tr>\n";
	echo "<form method=\"post\">\n";
	echo "<input type=\"hidden\" name=\"action\" value=\"est\">\n";
	echo "<input type=\"hidden\" name=\"call\" value=\"view_addnew\">\n";
...
function viewest_retail_NEW()
{
	...
	if ($viewarray['renov']==1)
	{
		$qryQ  = "select cmid,rwdrate,ctgry from jest..CommissionBuilder where oid=".$_SESSION['officeid']." and active=1 and ctgry=1 and renov=1;";
	}
	else
	{
		$qryQ  = "select cmid,rwdrate,ctgry from jest..CommissionBuilder where oid=".$_SESSION['officeid']." and active=1 and ctgry=1 and renov=0;";
	}
	...
	//echo "<script type=\"text/javascript\" src=\"js/jquery.currency.min.js\"></script>\n";
	...
	*/
	...
	{
		echo "				<span class=\"JMStooltip\" id=\"OpenPBAdjustDialog\" title=\"Adjust Price per Book\"><a href=\"#\"><b>+/-</b></a></span>\n";
	}
	else
	{
		echo "				<img src=\"images/pixel.gif\">\n";
	...
	echo "              <td class=\"wh\" align=\"right\" width=\"".$col_struct[4]."px\">".$fadjbookamt."</td>\n";
	...
	if ($rowC[2]==1)
	{
		echo "			<tr>\n";
		echo "				<td align=\"right\"><img src=\"images/pixel.gif\"></td>\n";
		echo "				<td align=\"right\"><b>Tax (".$taxrate[1]."):</b></td>\n";
		echo "				<td align=\"right\"><img src=\"images/pixel.gif\"></td>\n";
		echo "				<td align=\"right\"><img src=\"images/pixel.gif\"></td>\n";
		echo "				<td align=\"right\">".$frtax."</td>\n";
		echo "				<td align=\"right\"><img src=\"images/pixel.gif\"></td>\n";
	...
	if (isset($fctramt) and $fctramt > 0)
	{
		if ($nrowQ > 0)
		{
			...
			{
				//if (isset($_SESSION['modcomm']) and $_SESSION['modcomm'] >= 1 and $_SESSION['securityid']!=26)
				if (isset($_SESSION['modcomm']) and $_SESSION['modcomm'] >= 1)
				{
					//$tadjcomm=CommissionScheduleRO_NEW_EDIT($commarray,$col_struct);
					$tadjcomm=CommissionScheduleRO_NEW_EDIT_TED($commarray,$col_struct);
				}
				else
				{
...
function viewest_cost()
{
	...
	if (!isset($viewarray['estid'])||$viewarray['estid']=='')
	{
...
function estimate_matrix()
{
	...
	{
		include ('poolmatrix_support_func_TED.php');
	}
	else
	{
		include ('poolmatrix_support_func.php');
	}
	...
	{
		apply_overage($_SESSION['estid']);
	}
	elseif ($_SESSION['call']=="deleteou")
	{
		delete_overage($_SESSION['estid']);
	}
