...
//echo "User Comment File entry<br>";
...
{
    $qry	= "SELECT officeid,admstaff FROM security WHERE securityid='".$_SESSION['securityid']."' and substring(slevel,13,1) >= 1;";
	$res	= mssql_query($qry);
    ...
    else
    {
		...
		echo "			            <table align=\"center\" width=\"100%\">\n";
        echo "							<tr>\n";
		echo "								<td colspan=\"2\" align=\"left\">Add Comment for ".$row1['name']."</td>";
		echo "							</tr>\n";
        echo "			            	<tr>\n";
        echo "					            <td align=\"left\" colspan=\"2\">\n";
        echo "                                  <textarea name=\"addctext\" cols=\"82\" rows=\"5\"></textarea>\n";
        echo "                              </td>\n";
		echo "				            </tr>\n";
        echo "				            <tr>\n";
		...
		if ($row['admstaff'] > 1)
		{
			echo "						<b>Security:</b> <select name=\"seclevel\">\n";
        ...
        echo "                              </td>\n";
		echo "					            <td align=\"right\">\n";
        echo "		                            <input class=\"checkboxgry\" type=\"image\" src=\"images/comment_add.png\" alt=\"Add Office Comment\">\n";
        echo "                              </td>\n";
        echo "				            </tr>\n";
        echo "			            </table>\n";
        echo "                      </form>\n";
		...
		echo "				</tr>\n";
        echo "				<tr>\n";
		echo "					<td colspan=\"6\" align=\"center\"><hr width=\"100%\"></td>\n";
		echo "				</tr>\n";
		echo "				<tr>\n";
		...
		echo "				</tr>\n";
		echo "				<tr>\n";
        echo "					<td class=\"wh_und\" align=\"right\" width=\"25px\"></td>\n";
		echo "					<td class=\"ltgray_und\" align=\"left\" width=\"90px\"><b>Date</b></td>\n";
		echo "					<td class=\"ltgray_und\" align=\"left\" width=\"85px\"><b>Recorder</b></td>\n";
        ...
        {	
            ...
            echo "	                    <form name=\"deletecomment\" method=\"post\">\n";
			echo "	                	    <input type=\"hidden\" name=\"action\" value=\"reports\">\n";
			echo "	                    	<input type=\"hidden\" name=\"call\" value=\"office\">\n";
			echo "	                    	<input type=\"hidden\" name=\"subq\" value=\"deletecomment\">\n";
            echo "                          <input type=\"hidden\" name=\"oid\" value=\"".$row0['oid']."\">\n";
			echo "	                    	<input type=\"hidden\" name=\"offcntid\" value=\"".$row0['offcntid']."\">\n";
			echo "		                    <input class=\"".$tbgc."\" type=\"image\" src=\"images/comment_delete.png\" alt=\"Delete Office Comment\">\n";
			echo "	                    </form>\n";
            echo "                  </td>\n";
            echo "				</tr>\n";    
        }
...
function deletecomment()
{
    ...
    {
        $qry0	 = "UPDATE jest..office_comments SET hidden=1,hiddenby=".$_SESSION['securityid']." WHERE offcntid=".$_REQUEST['offcntid'].";";
        $res0	= mssql_query($qry0);
    }
