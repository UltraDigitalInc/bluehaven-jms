...
function basematrix() {
	...
	elseif ($_SESSION['call']=="view")
	{
        ...
        else
        {
			...
			if (isset($_SESSION['tester']) and $_SESSION['tester']==1)
			{
				@LeadView($_REQUEST['cid'],$_REQUEST['uid']);
			}
			else
			{
				@cform_view();
...
function lead_export()
{
	...
	echo "							<tr class=\"tblhd\">\n";
	echo "								<td align=\"left\"><b>Lead Export</b></td>\n";
	echo "                              <td align=\"right\"><img class=\"JMStooltip\" src=\"images/help.png\" title=\"Use this Export Tool to Extract Lead Records for Mailing Lists or Email Campaigns\"></td>\n";
	echo "							</tr>\n";
	echo "							<tr>\n";
	...
	echo "											</td>\n";
	echo "											<td valign=\"top\">\n";
	echo "													<button>Export <img src=\"images/page_excel.png\" title=\"This button will create a comma de-limited text file with Customer Information originated in the JMS within Date Range indicated.\"></button>\n";
	echo "											</td>\n";
	echo "										</tr>\n";
	echo "									</table>\n";
	echo "								</td>\n";
...
function selectemailtemplate_NEW($oid,$sid,$cid,$ttid)
{
	...
	if ($nrowET1 > 0) {
		...
		while ($rowET1 = mssql_fetch_array($resET1))
		{
			...
			{
				echo "				<option value=\"".$rowET['etid']."\">".$rowET1['name']."</option>\n";
			}
		}
...
function search_panel()
{
	...
	echo "<script type=\"text/javascript\" src=\"js/jquery_extend.js?".time()."\"></script>\n";
...
function cform_view($tcid)
{
	...
	echo "			<tr>\n";
	echo "				<td valign=\"top\">\n";
	echo "					<button class=\"leadBtns\" id=\"submitleadupdate\" title=\"Update Customer Info, Address, and Appointment/Result for this Lead\">Update</button>\n";
	echo "				</td>\n";	
	echo "			</tr>\n";
	echo "			<tr>\n";
	echo "				<td valign=\"top\">\n";
	...
	if ($_REQUEST['uid']!="XXX")
	{
		...
		echo "         			<input type=\"hidden\" name=\"custid\" value=\"".$cid."\">\n";
		echo "					<button class=\"leadBtns\" title=\"View OneSheet for this Customer\">OneSheet</button>\n";
		echo "				</form>\n";
	}
	...
	if ($_SESSION['llev'] >= 4 && $_REQUEST['uid']!="XXX")
	{
		...
		echo "         			<input type=\"hidden\" name=\"uid\" value=\"".$_REQUEST['uid']."\">\n";
		echo "         			<input type=\"hidden\" name=\"cid\" value=\"".$cid."\">\n";
		echo "					<button class=\"leadBtns\" title=\"View Lead Update History\">History</button>\n";
		echo "				</form>\n";
	}
	...
	if ($_SESSION['elev'] >= 1 && $rowC[1]==1)
	{
		if ($rowF['dupe']==0 && $rowF['jobid']=='0')
		{
			...
			echo "         				<input type=\"hidden\" name=\"estorig\" value=\"".$rowF['securityid']."\">\n";
			echo "         				<input type=\"hidden\" name=\"securityid\" value=\"".$rowF['securityid']."\">\n";
			echo "						<button class=\"leadBtns\" title=\"Create a new Quote\">Quote</button>\n";
			echo "					</form>\n";
			echo "				</td>\n";
			echo "			</tr>\n";
		}
		...
		if ($rowF['dupe']==0 && $rowF['jobid']=='0')
		{
			...
			echo "         				<input type=\"hidden\" name=\"estorig\" value=\"".$rowF['securityid']."\">\n";
			echo "         				<input type=\"hidden\" name=\"securityid\" value=\"".$rowF['securityid']."\">\n";
			echo "						<button class=\"leadBtns\" title=\"Create a new Estimate\">Estimate</button>\n";
			echo "					</form>\n";
			echo "				</td>\n";
			echo "			</tr>\n";
		}
	...
	if ($_SESSION['securityid'] == 26999999999999999999999999999)
	{
		...
		echo "						<input type=\"hidden\" name=\"cid\" value=\"".$rowF['cid']."\">\n";
		echo "						<button class=\"leadBtns\" title=\"Create a new Sales Cart\">New Cart</button>\n";
		echo "					</form>\n";
		echo "				</td>\n";
		echo "			</tr>\n";
	}
	...
	if (isset($rowM['filestoreaccess']) && $rowM['filestoreaccess'] >= 99)
	{
		...
		echo "						<input type=\"hidden\" name=\"cid\" value=\"".$rowF['cid']."\">\n";
		echo "						<button class=\"leadBtns\" title=\"View files for this Lead\">Files</button>\n";
		echo "					</form>\n";
		echo "				</td>\n";
		echo "			</tr>\n";
	}
	...
	if (isset($_SESSION['tqry']))
	{
		...
		echo "						<input type=\"hidden\" name=\"call\" value=\"search_results\">\n";
		echo "						<input type=\"hidden\" name=\"subq\" value=\"sstring\">\n";
		echo "						<button class=\"leadBtns\" title=\"Return to the Last Search Results\">Search Results</button>\n";
...
function displayCommentTable()
{
	...
	echo "																<table>\n";
	echo "																	<tr>\n";
	echo "																		<td align=\"right\" id=\"expandCommentContainer\">\n";
...
function cform_add()
{
	...
	*/
		...
		if (isset($rowC[0]) && $rowC[0] != 0)
		{
			...
			@LeadView($rowC[0],$_SESSION['securityid']);
		}
		else
		{
