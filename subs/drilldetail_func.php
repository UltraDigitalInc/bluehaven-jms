...
function drill_bid_add()
{
   ...
   echo "			<table class=\"outer\" width=\"100%\">\n";
   echo "				<tr>\n";
   echo "					<td class=\"gray\" align=\"left\" valign=\"bottom\"><b>Add Bid Item Cost</b></td>\n";
   echo "				</tr>\n";
   echo "				<tr>\n";
   echo "					<td class=\"gray\" align=\"left\">\n";
   echo "						<table width=\"100%\">\n";
   echo "							<tr>\n";
   echo "								<td align=\"right\" valign=\"bottom\" width=\"125px\"><b>Customer:</b></td><td align=\"left\" valign=\"bottom\">".$rowB['clname'].", ".$rowB['cfname']."</td>\n";
   echo "							</tr>\n";
   echo "							<tr>\n";

   if ($_GET['action']=="est")
   {
	   echo "								<td align=\"right\" valign=\"bottom\" width=\"125px\"><b>Estimate:</b></td><td align=\"left\" valign=\"bottom\">".$disp_jid[0]."</td>\n";
   }
   elseif ($_GET['action']=="contract")
   {
	   echo "								<td align=\"right\" valign=\"bottom\" width=\"125px\"><b>Contract:</b></td><td align=\"left\" valign=\"bottom\">".$disp_jid[0]."</td>\n";
   }
   elseif ($_GET['action']=="job")
   {
	   echo "								<td align=\"right\" valign=\"bottom\" width=\"125px\"><b>Job:</b></td><td align=\"left\" valign=\"bottom\">".$disp_jid[0]."</td>\n";
   }
   ...
   if ($nrowCb > 0)
   {
	  echo "						<form action=\"http://jms.bhnmi.com/index.php\" method=\"post\" target=\"JMSmain\" onSubmit=\"JavaScript: window.close()\">\n";
	  //echo "						<form action=\"http://jms.bhnmi.com/index.php\" method=\"post\" target=\"JMSmain\">\n";
	...
	{	
			...
			if ($nrowD > 0)
			{
				...
				*/
				...
				//echo "						<tr>\n";
				//echo "							<td class=\"gray\" align=\"right\" colspan=\"4\"><b>Cost Total:</b></td>\n";
				//echo "							<td class=\"wh_und\" align=\"right\">".number_format($tprice, 2, '.', '')."</td>\n";
				//echo "						</tr>\n";
				echo "					</td>\n";
				echo "				</tr>\n";
