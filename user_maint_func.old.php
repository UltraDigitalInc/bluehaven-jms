...
function resetuserpword()
{
	if (!isset($_REQUEST['state'])||empty($_REQUEST['state']))
	{
		...
		{
			$userid=$_SESSION['securityid'];
		}
		
		$qryA = "SELECT securityid,officeid,fname,lname,login,startpage,slevel,returntolist,searchlandingpage FROM jest..security WHERE securityid='".$userid."';";
		$resA = mssql_query($qryA);
		$rowA = mssql_fetch_array($resA);
		...
		echo "<tr>\n";
		echo "   <td class=\"ltgray_und\" colspan=\"2\" align=\"left\"><b>Account Options</b></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Login ID</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\"><b>".$rowA['login']."</b></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>First Name</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\">".$rowA['fname']."</td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Last Name</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\">".$rowA['lname']."</td>\n";
		echo "</tr>\n";
		
		/*
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Start Page:</b></td>\n";
		echo "   <td class=\"gray\">\n";
		...
		{
			if ($rowA['startpage']==$rowB['startid'])
			{
				echo "			<option value=\"".$rowB['startid']."\" SELECTED>".$rowB['sname']."</option>\n";
			}
			else
			{
				echo "			<option value=\"".$rowB['startid']."\">".$rowB['sname']."</option>\n";	
			}
		}
		...
		*/
		...
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Search Landing Page</b></td>\n";
		...
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Lead Update</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\">\n";
		...
		echo "<table align=\"center\" width=\"300px\">\n";
		echo "<tr>\n";
		echo "   <td class=\"ltgray_und\" colspan=\"2\" align=\"left\"><b>Reset Password</b></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>New Password</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\"><input class=\"bboxb\" type=\"password\" name=\"p1\" size=\"10\" maxlength=\"8\"></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\"><b>Verify New Password</b></td>\n";
		echo "   <td class=\"gray\" align=\"left\"><input class=\"bboxb\" type=\"password\" name=\"p2\" size=\"10\" maxlength=\"8\"></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
		echo "   <td class=\"gray\" align=\"right\" colspan=\"2\"><input class=\"buttondkgry\" type=\"submit\" value=\"Reset Password\"></td>\n";
		echo "</tr>\n";
		echo "</form>\n";
		echo "</table>\n";
	}
	...
	{
		$qryA = "SELECT securityid,fname,lname,login,pswd,logstate,startpage FROM security WHERE securityid='".$_REQUEST['userid']."';";
		$resA = mssql_query($qryA);
	...
	elseif ($_REQUEST['state']=='setopts')
	{
		...
		if ($nrowA > 0)
		{
			//$qryB = "UPDATE security SET startpage='".$_REQUEST['startpage']."',returntolist=".$_REQUEST['returntolist']." WHERE securityid='".$rowA[0]."'";
			...
			echo "<b>Account settings have been Updated</b><br>";
		}
	}
}
...
function viewuser()
{
	...
	echo "										</td>\n";
	echo "   									<td class=\"gray\" valign=\"center\"></td>\n";
	...
	echo "<input type=\"hidden\" name=\"userid\" id=\"UserSID\" value=\"".$row[0]."\">\n";
	echo "<input type=\"hidden\" name=\"office\" value=\"".$row[1]."\">\n";
	echo "<input type=\"hidden\" name=\"off_demo\" value=\"".$row[21]."\">\n";
	echo "<input type=\"hidden\" name=\"adminid\" value=\"".$_SESSION['securityid']."\">\n";
	echo "<input type=\"hidden\" name=\"officeid\" value=\"".$row[1]."\">\n";
	echo "<input type=\"hidden\" name=\"dsgfperiod\" value=\"".trim($row[23])."\">\n";
	echo "<input type=\"hidden\" name=\"dsgfarray\" value=\"".trim($row[24])."\">\n";
	echo "<input type=\"hidden\" name=\"menutype\" value=\"O\">\n";
	echo "<input type=\"hidden\" name=\"emailchrg\" value=\"".$row[33]."\">\n";
	echo "<input type=\"hidden\" name=\"JobCommEdit\" value=\"".$row[51]."\">\n";
	*/
