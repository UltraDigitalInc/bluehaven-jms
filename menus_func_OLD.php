...
function reports_button_menu()
{
	...
	if ($_SESSION['rlev'] >= 1 && $row2['screport'] >=1)
	{
		echo "      			<td align=\"right\">\n";
		echo "         				<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"reports\">\n";
	...
	if ($_SESSION['rlev'] >= 6 && $row2['gmreports'] > 0 && $row1['finan_off']==0)
	{
		echo "      			<td align=\"right\">\n";
		echo "         				<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"reports\">\n";
	...
	if ($row2['constructdateaccess'] >= 5 && $row2['jobprogress'] >=1)
	{
		echo "      			<td align=\"right\">\n";
		echo "         				<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"job\">\n";
	...
	{
		echo "   			<tr>\n";
		echo "      			<td align=\"right\" colspan=\"3\"><b>Admin Only</b></td>\n";
		echo "      			<td align=\"right\">\n";
		echo "         				<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"reports\">\n";
...
function maint_button_menu($valdis)
{
	...
	if ($_SESSION['mlev'] >= 9 && $_SESSION['m_llev'] >= 9 && $_SESSION['officeid']==8900000000000000000000000000000000)
	{
		echo "      		<td align=\"right\">\n";
		echo "         			<form method=\"post\">\n";
		echo "						<input type=\"hidden\" name=\"action\" value=\"maint\">\n";
