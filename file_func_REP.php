...
function FileBaseMatrix()
{
	...
	//echo 'DEV MODE<br>';
	if ($_SESSION['securityid']==2699999999999999999999999999999)
	{
		echo 'Test';
	}
...
function list_file_OFF()
{
	...
	{		
		if ($row0['filestoreaccess'] > 5)
		{
			...
			{
				echo "<script type=\"text/javascript\" src=\"js/jquery_file_func_031312.js\"></script>\n";
			}
			else
			{
				echo "<script type=\"text/javascript\" src=\"js/jquery_file_func.js\"></script>\n";
			...
			{
				parse_tree_live_OFF($tree_ar,$row0['filestoreaccess'],true);
			}
			else
			{
				...
				if ($nrow > 0)
				{
					...
					while ($row=mssql_fetch_array($res))
					{
						...
						if ($row['active']==1)
						{
							...
							{
								echo "<a href=\"http://jms.bhnmi.com/subs/showimage.php?docid=".$row['docid']."\"><img class=\"JMSimgtooltip\" src=\"export/fileout.php?storetype=file&docid=".$row['docid']."\" height=\"16px\" width=\"16px\" title=\"".$row['filename']."\"></a>\n";
							}
						}
