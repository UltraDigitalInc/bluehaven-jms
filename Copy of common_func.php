...
{
	$qry0 = "SELECT securityid,officeid,login,fname,lname,slevel,mlevel,off_demo,csrep,emailtemplateaccess,officelist,modcomm,acctngrelease FROM security WHERE securityid=".$sid.";";
...
function display_Lead_Search_Ajax()
{
	...
	<script type="text/javascript" src="js/jquery_lead_search_ajx.js"></script>
...
function display_CB_AP_NEW1()
{
	...
	echo "<script type=\"text/javascript\" src=\"js/jquery_lead_search.js\"></script>\n";
	echo "<table class=\"transnb\" align=\"center\" width=\"950px\">\n";
	echo "	<tr>\n";
	echo "		<td class=\"transnb\" align=\"left\">\n";
	echo "			<div id=\"AP_CB_menu\">\n";
	echo "				<ul>\n";
	...
	if ($nrowAP > 0)
	{
		...
		foreach ($ap_ar as $nAP => $vAP)
		{
			...
			echo "				<tr class=\"".$tbgAP."\">\n";
			echo "					<td align=\"right\">".$rcntAP++.".</td>\n";
			echo "					<td align=\"left\">".trim($vAP['clname']).", ".trim($vAP['cfname'])."</td>\n";
			echo "					<td align=\"left\">".trim($vAP['scity'])."</td>\n";
			echo "					<td align=\"center\">".$vAP['szip1']."</td>\n";
			echo "					<td align=\"left\">".$vAP['lname'].", ".$vAP['fname']."</td>\n";
			echo "					<td align=\"center\">\n";
			echo "						<table width=\"100\">\n";
			echo "							<tr>\n";
			echo "								<td align=\"left\">\n";
			echo "						".str_pad($vAP['appt_mo'],2,'0',STR_PAD_LEFT)."/".str_pad($vAP['appt_da'],2,'0',STR_PAD_LEFT)."/".$vAP['appt_yr']." ";	
			echo "								</td>\n";
			echo "								<td align=\"right\">\n";
			echo "						".$vAP['appt_hr'].":". str_pad(trim($vAP['appt_mn']), 2, STR_PAD_LEFT) ."";
			...
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['chome'])));
			}
			elseif (isset($vAP['ccell']) && !in_array($vAP['ccell'],$nph_ar) && strlen($vAP['ccell']) > 2)
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['ccell'])));
			}
			elseif (isset($vAP['cwork']) && !in_array($vAP['cwork'],$nph_ar) && strlen($vAP['cwork']) > 2)
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['cwork'])));
			}
			...
			echo "						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
			echo "						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
			echo "						<input type=\"hidden\" name=\"cid\" id=\"recid\" value=\"".$vAP['cid']."\">\n";
			echo "						<input type=\"hidden\" name=\"uid\" value=\"".$uidAP."\">\n";
			...
			if (in_array($_SESSION['securityid'],$dev_ar))
			{
				...
				@gen_CustLinkNode($vAP['cid'],$uidAP,$vAP['saddr1'],$vAP['scity'],$vAP['sstate'],$vAP['szip1']);
	...
	if ($nrowCB > 0)
	{
		...
		foreach ($cb_ar as $nCB => $vCB)
		{
			...
			echo "				<tr class=\"".$tbgCB."\">\n";
			echo "					<td align=\"right\">".$rcntCB++.".</td>\n";
			echo "					<td align=\"left\">".$vCB['clname'].", ".$vCB['cfname']."</td>\n";
			echo "					<td align=\"left\">".$vCB['scity']."</td>\n";
			echo "					<td align=\"left\">".$vCB['szip1']."</td>\n";
			echo "					<td align=\"left\">".$vCB['lname'].", ".$vCB['fname']."</td>\n";
			echo "					<td align=\"center\">".$vCB['hold_mo']."/".$vCB['hold_da']."/".$vCB['hold_yr']."</td>\n";
			echo "					<td align=\"center\">";
			
			if (isset($vCB['chome']) && !in_array($vCB['chome'],$nph_ar) && strlen($vCB['chome']) > 2)
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['chome'])));
			}
			elseif (isset($vCB['ccell']) && !in_array($vCB['ccell'],$nph_ar) && strlen($vCB['ccell']) > 2)
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['ccell'])));
			}
			elseif (isset($vCB['cwork']) && !in_array($vCB['cwork'],$nph_ar) && strlen($vCB['cwork']) > 2)
			{
				echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['cwork'])));
			}
			...
			echo "						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
			echo "						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
			echo "						<input type=\"hidden\" name=\"cid\" id=\"recid\" value=\"".$vCB['cid']."\">\n";
			echo "						<input type=\"hidden\" name=\"uid\" value=\"".$uidCB."\">\n";
			...
			if (in_array($_SESSION['securityid'],$dev_ar))
			{
				...
				@gen_CustLinkNode($vCB['cid'],$uidCB,$vCB['saddr1'],$vCB['scity'],$vCB['sstate'],$vCB['szip1']);
	...
	if ($_SESSION['llev'] >= 5)
	{
		...
		if ($nrowNM > 0)
		{
			...
			foreach ($nm_ar as $nNM => $vNM)
			{
				...
				$uidNM  =md5(session_id().time().$vNM['cid']).".".$_SESSION['securityid'];
				echo "				<tr class=\"".$tbgNM."\">\n";
				echo "					<td align=\"right\">".$rcntNM++.".</td>\n";
				echo "					<td align=\"left\">".trim($vNM['clname']).", ".trim($vNM['cfname'])."</td>\n";
				echo "					<td align=\"left\">".trim($vNM['scity'])."</td>\n";
				echo "					<td align=\"center\">".$vNM['szip1']."</td>\n";				
				echo "					<td align=\"left\">".trim($vNM['lname']).", ".trim($vNM['fname'])."</td>\n";
				
				if ($vNM['source']==0)
				{
					echo "					<td align=\"left\">bluehaven.com</td>\n";
				}
				else
				{
					echo "					<td align=\"left\">".$vNM['lsource']."</td>\n";
				}
				...
				echo "							<tr>\n";
				echo "								<td align=\"left\">\n";
				echo date('m/d/y',strtotime($vNM['added']));
				echo "								</td>\n";
				echo "								<td align=\"right\">\n";
				echo date('g:iA',strtotime($vNM['added']));
				echo "								</td>\n";
				echo "							</tr>\n";
				echo "						</table>\n";
				echo "					</td>\n";
				...
				if (isset($vNM['chome']) && !in_array($vNM['chome'],$nph_ar) && strlen($vNM['chome']) > 2)
				{
					echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vNM['chome'])));
				}
				elseif (isset($vNM['ccell']) && !in_array($vNM['ccell'],$nph_ar) && strlen($vNM['ccell']) > 2)
				{
					echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vNM['ccell'])));
				}
				elseif (isset($vNM['cwork']) && !in_array($vNM['cwork'],$nph_ar) && strlen($vNM['cwork']) > 2)
				{
					echo format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vNM['cwork'])));
				}
				...
				echo "						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
				echo "						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
				echo "						<input type=\"hidden\" name=\"cid\" id=\"recid\" value=\"".$vNM['cid']."\">\n";
				echo "						<input type=\"hidden\" name=\"uid\" value=\"".$uidNM."\">\n";
				
				if ($_SESSION['officeid']==$vNM['officeid'])
				{
					echo "						<input class=\"transnb\" type=\"image\" src=\"images/folder_open.gif\" alt=\"View Lead\">\n";
				}
				...
				if (in_array($_SESSION['securityid'],$dev_ar))
			{
					...
					@gen_CustLinkNode($vNM['cid'],$uidNM,$vNM['saddr1'],$vNM['scity'],$vNM['sstate'],$vNM['szip1']);
...
function display_CB_AP_NEW2()
{
	...
	$show_ALL='';
	$show_ALL=$show_ALL."<table class=\"transnb\" align=\"center\" width=\"950px\">\n";
	$show_ALL=$show_ALL."	<tr>\n";
	$show_ALL=$show_ALL."		<td class=\"transnb\" align=\"left\">\n";
	$show_ALL=$show_ALL."			<div id=\"AP_CB_menu\">\n";
	$show_ALL=$show_ALL."				<ul>\n";
	
	if (isset($_REQUEST['shownm']) && $_REQUEST['shownm']==1)
	{
		$show_ALL=$show_ALL."					<li><a href=\"#ap\"><em>Appointments</em></a></li>\n";
		$show_ALL=$show_ALL."			    	<li><a href=\"#cb\"><em>Callbacks</em></a></li>\n";
		
		if ($_SESSION['llev'] >= 5)
		{
			$show_ALL=$show_ALL."			    	<li class=\"selected\"><a href=\"#nm\"><em>New from BHNM</em></a></li>\n";
		}
		
		if (in_array($_SESSION['securityid'],$dev_ar))
		{
			$show_ALL=$show_ALL."			    	<li><a href=\"#sc\"><em>Search</em></a></li>\n";
		}
	}
	elseif (isset($_REQUEST['showcb']) && $_REQUEST['showcb']==1)
	{
		$show_ALL=$show_ALL."					<li><a href=\"#ap\"><em>Appointments</em></a></li>\n";
		$show_ALL=$show_ALL."			    	<li class=\"selected\"><a href=\"#cb\"><em>Callbacks</em></a></li>\n";
		
		if ($_SESSION['llev'] >= 5)
		{
			$show_ALL=$show_ALL."			    	<li><a href=\"#nm\"><em>New from BHNM</em></a></li>\n";
		}
	...
	{
		$show_ALL=$show_ALL."					<li class=\"selected\"><a href=\"#ap\"><em>Appointments</em></a></li>\n";
		$show_ALL=$show_ALL."			    	<li><a href=\"#cb\"><em>Callbacks</em></a></li>\n";
	...
	{		
		...
		$show_ALL=$show_ALL."			<table class=\"transnb\" width=\"100%\">\n";
		$show_ALL=$show_ALL."				<tr>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"lightgreen\" width=\"20\"><img src=\"images/pixel.gif\"></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"lightgreen\" width=\"150\"><b>Customer</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"lightgreen\"><b>City</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"lightgreen\"><b>Zip</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"lightgreen\"><b>SalesRep</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"lightgreen\"><b>Appt Date/Time</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"lightgreen\"><b>Phone</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"lightgreen\">\n";		
		$show_ALL=$show_ALL."					</td>\n";
		$show_ALL=$show_ALL."				</tr>\n";
		...
		foreach ($ap_ar as $nAP => $vAP)
		{
			...
			$uidAP  =md5(session_id().time().$vAP['cid']).".".$_SESSION['securityid'];
			$show_ALL=$show_ALL."				<tr>\n";
			$show_ALL=$show_ALL."					<td align=\"right\" class=\"".$tbgAP."\">".$rcntAP++.".</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgAP."\">".trim($vAP['clname']).", ".trim($vAP['cfname'])."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgAP."\">".trim($vAP['scity'])."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"center\" class=\"".$tbgAP."\">".$vAP['szip1']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgAP."\">".$vAP['lname'].", ".$vAP['fname']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"center\" class=\"".$tbgAP."\">\n";
			$show_ALL=$show_ALL."						<table width=\"100\">\n";
			$show_ALL=$show_ALL."							<tr>\n";
			$show_ALL=$show_ALL."								<td align=\"left\">\n";
			$show_ALL=$show_ALL."									".str_pad($vAP['appt_mo'],2,'0',STR_PAD_LEFT)."/".str_pad($vAP['appt_da'],2,'0',STR_PAD_LEFT)."/".$vAP['appt_yr']." ";	
			$show_ALL=$show_ALL."								</td>\n";
			$show_ALL=$show_ALL."								<td align=\"right\">\n";
			$show_ALL=$show_ALL."									".$vAP['appt_hr'].":". str_pad(trim($vAP['appt_mn']), 2, STR_PAD_LEFT) ."";
			
			if ($vAP['appt_pa']==2)
			{
				$show_ALL=$show_ALL.'PM';
			}
			else
			{
				$show_ALL=$show_ALL.'AM';
			}
			
			$show_ALL=$show_ALL."								</td>\n";
			$show_ALL=$show_ALL."							</tr>\n";
			$show_ALL=$show_ALL."						</table>\n";
			$show_ALL=$show_ALL."					</td>\n";
			$show_ALL=$show_ALL."					<td align=\"center\" class=\"".$tbgAP."\">";
			
			if (isset($vAP['chome']) && !in_array($vAP['chome'],$nph_ar) && strlen($vAP['chome']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['chome'])));
			}
			elseif (isset($vAP['ccell']) && !in_array($vAP['ccell'],$nph_ar) && strlen($vAP['ccell']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['ccell'])));
			}
			elseif (isset($vAP['cwork']) && !in_array($vAP['cwork'],$nph_ar) && strlen($vAP['cwork']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vAP['cwork'])));
			}
			
			$show_ALL=$show_ALL."					</td>\n";
			$show_ALL=$show_ALL."					<td class=\"".$tbgAP."\" align=\"center\">\n";
			$show_ALL=$show_ALL."					<form method=\"POST\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"cid\" value=\"".$vAP['cid']."\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"uid\" value=\"".$uidAP."\">\n";
			
			if ($_SESSION['officeid']==$vAP['officeid'])
			{
				$show_ALL=$show_ALL."						<input class=\"transnb\" type=\"image\" src=\"images/folder_open.gif\" alt=\"View Lead\">\n";
			}
			
			$show_ALL=$show_ALL."					</form>\n";
			$show_ALL=$show_ALL."					</td>\n";
			$show_ALL=$show_ALL."				</tr>\n";
			...
			{
				$show_ALL=$show_ALL."				<tr>\n";
				$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgAP."\"><img src=\"images/pixel.gif\"></td>\n";
				$show_ALL=$show_ALL."					<td colspan=\"9\" align=\"left\" class=\"".$tbgAP."\">\n";
				
				$show_ALL=$show_ALL.@gen_CustLinkNode($vAP['cid'],$uidAP,$vAP['saddr1'],$vAP['scity'],$vAP['sstate'],$vAP['szip1']);
	...
	$show_ALL=$show_ALL."						</p>\n";
	$show_ALL=$show_ALL."				    </div>\n";
	$show_ALL=$show_ALL."				    <div id=\"cb\">\n";
	$show_ALL=$show_ALL."						<p>\n";
	...
	if ($nrowCB > 0)
	{
		...
		$show_ALL=$show_ALL."			<table class=\"transnb\" width=\"100%\">\n";
		$show_ALL=$show_ALL."				<tr>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"magenta\" width=\"20\"><img src=\"images/pixel.gif\"></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"magenta\" width=\"150\"><b>Customer</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"magenta\"><b>City</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"magenta\"><b>Zip</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"left\" class=\"magenta\"><b>SalesRep</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"magenta\"><b>Callback Date</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"magenta\"><b>Phone</b></td>\n";
		$show_ALL=$show_ALL."					<td align=\"center\" class=\"magenta\">\n";
		$show_ALL=$show_ALL."					</td>\n";
		$show_ALL=$show_ALL."				</tr>\n";	
		...
		foreach ($cb_ar as $nCB => $vCB)
		{
			...
			$uidCB  =md5(session_id().time().$vCB['cid']).".".$_SESSION['securityid'];
			$show_ALL=$show_ALL."				<tr>\n";
			$show_ALL=$show_ALL."					<td align=\"right\" class=\"".$tbgCB."\">".$rcntCB++.".</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgCB."\">".$vCB['clname'].", ".$vCB['cfname']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgCB."\">".$vCB['scity']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgCB."\">".$vCB['szip1']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgCB."\">".$vCB['lname'].", ".$vCB['fname']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"center\" class=\"".$tbgCB."\">".$vCB['hold_mo']."/".$vCB['hold_da']."/".$vCB['hold_yr']."</td>\n";
			$show_ALL=$show_ALL."					<td align=\"center\" class=\"".$tbgCB."\">";
			
			if (isset($vCB['chome']) && !in_array($vCB['chome'],$nph_ar) && strlen($vCB['chome']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['chome'])));
			}
			elseif (isset($vCB['ccell']) && !in_array($vCB['ccell'],$nph_ar) && strlen($vCB['ccell']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['ccell'])));
			}
			elseif (isset($vCB['cwork']) && !in_array($vCB['cwork'],$nph_ar) && strlen($vCB['cwork']) > 2)
			{
				$show_ALL=$show_ALL.format_phonenumber(preg_replace('/\.|-|\s/i','$1$2$3',trim($vCB['cwork'])));
			}
			
			$show_ALL=$show_ALL."					</td>\n";
			$show_ALL=$show_ALL."					<td class=\"".$tbgCB."\" align=\"center\">\n";
			$show_ALL=$show_ALL."					<form method=\"POST\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"cid\" value=\"".$vCB['cid']."\">\n";
			$show_ALL=$show_ALL."						<input type=\"hidden\" name=\"uid\" value=\"".$uidCB."\">\n";
			...
			{
				$show_ALL=$show_ALL."				<tr>\n";
				$show_ALL=$show_ALL."					<td align=\"left\" class=\"".$tbgCB."\"><img src=\"images/pixel.gif\"></td>\n";
				$show_ALL=$show_ALL."					<td colspan=\"9\" align=\"left\" class=\"".$tbgCB."\">\n";
				
				$show_ALL=$show_ALL.@gen_CustLinkNode($vCB['cid'],$uidCB,$vCB['saddr1'],$vCB['scity'],$vCB['sstate'],$vCB['szip1']);
	...
	if ($_SESSION['llev'] >= 99999)
	{
		...
		if ($nrowNM > 0)
		{
			...
			foreach ($nm_ar as $nNM => $vNM)
			{
				...
				echo "				<tr>\n";
				echo "					<td align=\"right\" class=\"".$tbgNM."\">".$rcntNM++.".</td>\n";
				echo "					<td align=\"left\" class=\"".$tbgNM."\">".trim($vNM['clname']).", ".trim($vNM['cfname'])."</td>\n";
				echo "					<td align=\"left\" class=\"".$tbgNM."\">".trim($vNM['scity'])."</td>\n";
				echo "					<td align=\"center\" class=\"".$tbgNM."\">".$vNM['szip1']."</td>\n";				
				echo "					<td align=\"left\" class=\"".$tbgNM."\">".trim($vNM['lname']).", ".trim($vNM['fname'])."</td>\n";
				...
				{
					echo "					<td align=\"left\" class=\"".$tbgNM."\">".$vNM['lsource']."</td>\n";
				}
				...
				echo "						<input type=\"hidden\" name=\"action\" value=\"leads\">\n";
				echo "						<input type=\"hidden\" name=\"call\" value=\"view\">\n";
				echo "						<input type=\"hidden\" name=\"cid\" value=\"".$vNM['cid']."\">\n";
				echo "						<input type=\"hidden\" name=\"uid\" value=\"".$uidNM."\">\n";
...
function ExtEmailSendSSL($emc)
{
    ...
    if(!$mail->Send())
    {
		...
		//echo 'Error';
	    $qry	 = "insert into jest..EmailTracking (oid,lid,tid,cid,uid,sdate,emailaddr,emailaddrfrom,errors,msgid) values ";
	    $qry	.= "(".$emc['oid'].",".$emc['lid'].",".$emc['tid'].",".$emc['cid'].",".$emc['uid'].",getdate(),'".$xito."','".$emc['from']."','".$mail->ErrorInfo."','".$mail->MessageID."');";
	    $res	 = mssql_query($qry);
    ...
    else
    {
		...
		$qry	 = "insert into jest..EmailTracking (oid,lid,tid,cid,uid,sdate,emailaddr,emailaddrfrom,apptmnt,callback,msgid) values ";
		$qry	.= "(".$emc['oid'].",".$emc['lid'].",".$emc['tid'].",".$emc['cid'].",".$emc['uid'].",getdate(),'".$xito."','".$emc['from']."','".$emc['appt']."','".$emc['callb']."','".$mail->MessageID."');";
		$res	 = mssql_query($qry);
		...
		if ($emc['chistory'])
		{
			...
			$qry1 .= "VALUES ";
			$qry1 .= "('".$emc['oid']."','".$emc['uid']."','".$emc['cid']."','leads','".$xet_uid."','".$emc['ename']." Email Sent to ".$xito."',0,0,0,0,0);";
			$res1  = mssql_query($qry1);
...
function zip_maintold()
{
	$qry1 = "SELECT officeid,name,zip,active FROM offices ORDER BY name ASC;";
	$res1 = mssql_query($qry1);
	$nrow1= mssql_num_rows($res1);
	...
	echo "			<table class=\"outer\" width=\"100%\">\n";
	echo"					<tr>\n";
	echo "					<td align=\"left\" valign=\"top\"><b>Zip/Area/Prefix Search</b></td>\n";
	echo "				</tr>\n";
	echo "			</table>\n";
	echo "		</td>\n";
	echo "	</tr>\n";
	...
	echo "					<td bgcolor=\"#d3d3d3\" align=\"right\" valign=\"top\"><b>Select Office:</b></td>\n";
	echo "					<td bgcolor=\"#d3d3d3\" align=\"left\" valign=\"top\">\n";
	...
	while ($row1 = mssql_fetch_array($res1))
	{
		...
		echo "                           <option value=\"".$row1['zip']."\" class=\"".$ostyle."\">".$row1['name']."</option>\n";
	}
	...
	echo "								<input type=\"hidden\" name=\"call\" value=\"leads\">\n";
	echo "								<input type=\"hidden\" name=\"subq\" value=\"zip_search\">\n";
	echo "					<td bgcolor=\"#d3d3d3\" align=\"right\" valign=\"top\"><b>Zip/Area/Prefix:</b></td>\n";
	echo "					<td bgcolor=\"#d3d3d3\" align=\"left\" valign=\"top\">\n";
	echo "								<input class=\"bboxl\" type=\"text\" name=\"sdata\" size=\"20\" maxlength=\"5\">\n";
	echo "								<select name=\"type\">\n";
	echo "                           <option value=\"zip\">Zip Code</option>\n";
	echo "                           <option value=\"area\">Area Code</option>\n";
	echo "                           <option value=\"pre\">Phone Prefix</option>\n";
	echo "								</select>\n";
	echo "					</td>\n";
	echo "					<td bgcolor=\"#d3d3d3\" align=\"right\" valign=\"top\">\n";
	echo "								<input class=\"buttondkgrypnl80\" type=\"submit\" value=\"Search\">\n";
...
function zip_searchold()
{
	if ($_REQUEST['type']=="zip"||$_REQUEST['type']=="off")
	{
		$qry = "SELECT * FROM zip_link WHERE zip='".$_REQUEST['sdata']."' order by area ASC;";
	}
	elseif ($_REQUEST['type']=="area")
	{
		$qry = "SELECT * FROM zip_link WHERE area='".$_REQUEST['sdata']."' order by area ASC;";
	}
	elseif ($_REQUEST['type']=="pre")
	{
		$qry = "SELECT * FROM zip_link WHERE pre='".$_REQUEST['sdata']."' order by zip ASC;";
	}
	...
	if ($nrow > 0)
	{
		...
		echo "			<table class=\"outer\" width=\"100%\">\n";
		echo"					<tr>\n";
		echo "					<td bgcolor=\"#d3d3d3\" align=\"left\" valign=\"bottom\"><b>\n";

		if ($_REQUEST['type']=="off")
		{
			echo "Office";
		}
		elseif ($_REQUEST['type']=="zip")
		{
			echo "Zip Code";
		}
		elseif ($_REQUEST['type']=="area")
		...
		echo "			<table class=\"outer\" width=\"100%\">\n";
		echo"					<tr>\n";
		echo "					<td bgcolor=\"#d3d3d3\" valign=\"top\">\n";
		echo "						<table class=\"outer\" width=\"100%\">\n";
		echo"							<tr>\n";
		echo "							<td class=\"ltgray_und\" align=\"left\" valign=\"bottom\"><b>Office</b></td>\n";
		echo "							<td class=\"ltgray_und\" align=\"center\" valign=\"bottom\"><b>Zip Code</b></td>\n";
		echo "							<td class=\"ltgray_und\" align=\"center\" valign=\"bottom\"><b>Area Code</b></td>\n";
		echo "							<td class=\"ltgray_und\" align=\"center\" valign=\"bottom\"><b>Phone Prefix</b></td>\n";
		echo "							<td class=\"ltgray_und\" align=\"right\" valign=\"bottom\"></td>\n";
		echo"							</tr>\n";

		while ($row = mssql_fetch_array($res))
		{
			$qry1 = "SELECT officeid,name FROM offices WHERE zip='".$row['zip']."';";
			$res1 = mssql_query($qry1);
			$row1 = mssql_fetch_array($res1);

			echo"							<tr>\n";
			echo "							<td class=\"wh_und\" align=\"left\" valign=\"bottom\">".$row1['name']."</td>\n";
			echo "							<td class=\"wh_und\" align=\"center\" valign=\"bottom\">".$row['zip']."</td>\n";
			echo "							<td class=\"wh_und\" align=\"center\" valign=\"bottom\">".$row['area']."</td>\n";
			echo "							<td class=\"wh_und\" align=\"center\" valign=\"bottom\">".$row['pre']."</td>\n";
			echo "							<td class=\"wh_und\" align=\"right\" valign=\"bottom\"></td>\n";
			echo"							</tr>\n";
		}
	...
	else
	{
		...
		echo "			<table class=\"outer\" width=\"100%\">\n";
		echo"					<tr>\n";
		echo "					<td bgcolor=\"#d3d3d3\" align=\"left\" valign=\"top\">No Entries(s) Found for <b>".$_REQUEST['sdata']."</b></td>\n";
		echo "				</tr>\n";
		echo "			</table>\n";
		echo "		</td>\n";
		echo "	</tr>\n";
...
function systemwidemessage()
{
	...
	echo "<table border=0 width=\"950x\">\n";
	echo "   <tr>\n";
	echo "      <td colspan=\"3\">\n";
	echo "			<table class=\"outer\" width=100% border=\"0\">\n";
	echo "				<tr>\n";
	echo "      			<td class=\"gray\" align=\"left\" width=\"20%\"><b>System Messages</b></td>\n";
	echo "					<td class=\"gray\" align=\"center\" width=\"40%\"></td>\n";
	echo "					<td class=\"gray\" align=\"right\" width=\"40%\">\n";

	if (in_array($row['officeid'],$_SESSION['admin_offs']) && $_SESSION['llev'] >= 9 && $_SESSION['m_llev'] >= 8)
	{
	    @checklastleadimport();
	}
	...
	echo "			<div id=\"mainviewer\">\n";
	echo "				<ul>\n";
	echo "					<li><a href=\"#sysann\"><em>System Announcements</em></a></li>\n";
	echo "					<li><a href=\"#conlist\"><em>Contact List</em></a></li>\n";
	echo "				</ul>\n";
	echo "				<div id=\"sysann\">\n";
	...
	if ($_SESSION['officeid']==89 && in_array($row['officeid'],$_SESSION['admin_offs']) && $_SESSION['llev'] >= 5)
	{
		//echo 'XX';
	...
	{
		if ($_SESSION['llev'] >= 5 || $_SESSION['securityid'] == $row1['gm'] || $_SESSION['securityid'] == $row1['am'])
		{
			if ($row1['finan_off'] != 1)
			{
	...
	if ($_SESSION['rlev'] >= 5 || $_SESSION['csrep'] >= 5)
	{
		@activity_csr_office();
	}
...
function bh_html_header()
{
	...
	echo "		<title>".$row['SYS_NAME']." ".$row['SYS_VER']." (".$row['SYS_ENV'].")</title>\n";
	...
	?>
		...
		<script type="text/javascript" src="js/jms_help.js"></script>
...
function menu()
{
	...
	//$qryMSG  = "SELECT mid FROM messages WHERE sendto=".$_SESSION['securityid']." AND viewed=0;";
	//$resMSG  = mssql_query($qryMSG);
	//$nrowMSG = mssql_num_rows($resMSG);
	
    $qry0	= "SELECT S.officeid,S.menutype,S.emailtemplateaccess,(select otype_code from jest..offices where officeid=S.officeid) AS sotype_code FROM security AS S WHERE S.securityid=".$_SESSION['securityid'].";";
    $res0	= mssql_query($qry0);
    $row0	= mssql_fetch_array($res0);
    ...
    echo "		<tr>\n";
	echo "			<td align=\"center\" valign=\"top\">\n";
	echo "				<div id=\"menudiv\" align=\"center\">\n";
...
{
	$qry	= "SELECT finan_off FROM offices WHERE officeid='".$_SESSION['officeid']."';";
	$res	= mssql_query($qry);
	$row	= mssql_fetch_array($res);
	...
	{
		/*
		if ($_SESSION['securityid']==26 or $_SESSION['securityid']==332 or $_SESSION['securityid']==2190)
		{
			include ("./file_func_loader.php");
		}
		else
		{
			include ("./file_func_REP.php");
		}
		*/
...
function do_website()
{
	...
	{
		if (isset($_SESSION['securityid']) && $_SESSION['securityid']==269999999999999999999999999999999999999999)
		{
		    echo '<pre>';
			print_r($_REQUEST);
			echo '</pre>';
