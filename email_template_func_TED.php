...
function AddTemplate() {
    ...
    echo "<script type=\"text/javascript\" src=\"js/jquery_emailtemplate_func_TED.js\"></script>\n";
    echo "<table width=\"950px\">\n";
    echo "  <tr>\n";
    echo "      <td colspan=\"2\">\n";
    ...
    echo "              </tr>\n";
	echo "              <tr>\n";
    echo "                  <td align=\"right\"><b>Static File Attachment</b></td>\n";
    ...
    echo "                  <td colspan=\"2\" align=\"left\"><select id=\"UserFileAttach\" name=\"allowattach\"><option value=\"0\">No</option><option value=\"1\">Yes</option></select></td>\n";
    echo "              </tr>\n";
    echo "              <tr>\n";
...
function ViewTemplate() {
    ...
    if ($nrow0 > 0)
    {
		...
		echo "          <input type=\"hidden\" id=\"etid\" name=\"etid\" value=\"".$row0['etid']."\">\n";
		echo "          <table class=\"outer\" width=\"100%\">\n";
		echo "              <tr>\n";
        ...
        echo "							<a href=\"#\" id=\"emailtemplatereview\"><img src=\"images/email_open.png\" title=\"Email Template Preview\"></a>\n";
		echo "						</td>\n";
